...
addLayersControl(overlayGroups = c(autopav, autopav1),options = layersControlOptions(collapsed = FALSE)))
return(z)},
...
m7 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[7]][1])[-1], lng = unlist(lng[[7]][1])[-1], popup = as.character(unlist(c1[[7]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[7])%>%
...
m8 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[6]][1])[-1], lng = unlist(lng[[6]][1])[-1], popup = as.character(unlist(c1[[6]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[6])%>%
      addPopups(m, lat = unlist(lat[[7]][1])[-1], lng = unlist(lng[[7]][1])[-1], popup = as.character(unlist(c1[[7]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[7])%>%
      addPopups(m, lat = unlist(lat[[8]][1])[-1], lng = unlist(lng[[8]][1])[-1], popup = as.character(unlist(c1[[8]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[8])%>%
...
m9 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[7]][1])[-1], lng = unlist(lng[[7]][1])[-1], popup = as.character(unlist(c1[[7]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[7])%>%
      addPopups(m, lat = unlist(lat[[8]][1])[-1], lng = unlist(lng[[8]][1])[-1], popup = as.character(unlist(c1[[8]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[8])%>%
      addPopups(m, lat = unlist(lat[[9]][1])[-1], lng = unlist(lng[[9]][1])[-1], popup = as.character(unlist(c1[[9]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[9])%>%
...
m10 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[8]][1])[-1], lng = unlist(lng[[8]][1])[-1], popup = as.character(unlist(c1[[8]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[8])%>%
      addPopups(m, lat = unlist(lat[[9]][1])[-1], lng = unlist(lng[[9]][1])[-1], popup = as.character(unlist(c1[[9]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[9])%>%
      addPopups(m, lat = unlist(lat[[10]][1])[-1], lng = unlist(lng[[10]][1])[-1], popup = as.character(unlist(c1[[10]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[10])%>%
...
m11 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[9]][1])[-1], lng = unlist(lng[[9]][1])[-1], popup = as.character(unlist(c1[[9]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[9])%>%
      addPopups(m, lat = unlist(lat[[10]][1])[-1], lng = unlist(lng[[10]][1])[-1], popup = as.character(unlist(c1[[10]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[10])%>%
      addPopups(m, lat = unlist(lat[[11]][1])[-1], lng = unlist(lng[[11]][1])[-1], popup = as.character(unlist(c1[[11]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[11])%>%
...
m12 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[10]][1])[-1], lng = unlist(lng[[10]][1])[-1], popup = as.character(unlist(c1[[10]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[10])%>%
      addPopups(m, lat = unlist(lat[[11]][1])[-1], lng = unlist(lng[[11]][1])[-1], popup = as.character(unlist(c1[[11]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[11])%>%
      addPopups(m, lat = unlist(lat[[12]][1])[-1], lng = unlist(lng[[12]][1])[-1], popup = as.character(unlist(c1[[12]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[12])%>%
...
m13 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[11]][1])[-1], lng = unlist(lng[[11]][1])[-1], popup = as.character(unlist(c1[[11]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[11])%>%
      addPopups(m, lat = unlist(lat[[12]][1])[-1], lng = unlist(lng[[12]][1])[-1], popup = as.character(unlist(c1[[12]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[12])%>%
      addPopups(m, lat = unlist(lat[[13]][1])[-1], lng = unlist(lng[[13]][1])[-1], popup = as.character(unlist(c1[[13]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[13])%>%
...
m14 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[12]][1])[-1], lng = unlist(lng[[12]][1])[-1], popup = as.character(unlist(c1[[12]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[12])%>%
      addPopups(m, lat = unlist(lat[[13]][1])[-1], lng = unlist(lng[[13]][1])[-1], popup = as.character(unlist(c1[[13]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[13])%>%
      addPopups(m, lat = unlist(lat[[14]][1])[-1], lng = unlist(lng[[14]][1])[-1], popup = as.character(unlist(c1[[14]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[14])%>%
...
m15 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[13]][1])[-1], lng = unlist(lng[[13]][1])[-1], popup = as.character(unlist(c1[[13]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[13])%>%
      addPopups(m, lat = unlist(lat[[14]][1])[-1], lng = unlist(lng[[14]][1])[-1], popup = as.character(unlist(c1[[14]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[14])%>%
      addPopups(m, lat = unlist(lat[[15]][1])[-1], lng = unlist(lng[[15]][1])[-1], popup = as.character(unlist(c1[[15]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[15])%>%
...
m16 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[14]][1])[-1], lng = unlist(lng[[14]][1])[-1], popup = as.character(unlist(c1[[14]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[14])%>%
      addPopups(m, lat = unlist(lat[[15]][1])[-1], lng = unlist(lng[[15]][1])[-1], popup = as.character(unlist(c1[[15]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[15])%>%
      addPopups(m, lat = unlist(lat[[16]][1])[-1], lng = unlist(lng[[16]][1])[-1], popup = as.character(unlist(c1[[16]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[16])%>%
...
m17 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[15]][1])[-1], lng = unlist(lng[[15]][1])[-1], popup = as.character(unlist(c1[[15]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[15])%>%
      addPopups(m, lat = unlist(lat[[16]][1])[-1], lng = unlist(lng[[16]][1])[-1], popup = as.character(unlist(c1[[16]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[16])%>%
      addPopups(m, lat = unlist(lat[[17]][1])[-1], lng = unlist(lng[[17]][1])[-1], popup = as.character(unlist(c1[[17]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[17])%>%
...
m18 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[16]][1])[-1], lng = unlist(lng[[16]][1])[-1], popup = as.character(unlist(c1[[16]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[16])%>%
      addPopups(m, lat = unlist(lat[[17]][1])[-1], lng = unlist(lng[[17]][1])[-1], popup = as.character(unlist(c1[[17]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[17])%>%
      addPopups(m, lat = unlist(lat[[18]][1])[-1], lng = unlist(lng[[18]][1])[-1], popup = as.character(unlist(c1[[18]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[18])%>%
...
m19 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[17]][1])[-1], lng = unlist(lng[[17]][1])[-1], popup = as.character(unlist(c1[[17]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[17])%>%
      addPopups(m, lat = unlist(lat[[18]][1])[-1], lng = unlist(lng[[18]][1])[-1], popup = as.character(unlist(c1[[18]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[18])%>%
      addPopups(m, lat = unlist(lat[[19]][1])[-1], lng = unlist(lng[[19]][1])[-1], popup = as.character(unlist(c1[[19]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[19])%>%
...
m20 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[18]][1])[-1], lng = unlist(lng[[18]][1])[-1], popup = as.character(unlist(c1[[18]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[18])%>%
      addPopups(m, lat = unlist(lat[[19]][1])[-1], lng = unlist(lng[[19]][1])[-1], popup = as.character(unlist(c1[[19]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[19])%>%
      addPopups(m, lat = unlist(lat[[20]][1])[-1], lng = unlist(lng[[20]][1])[-1], popup = as.character(unlist(c1[[20]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[20])%>%
...
m21 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[19]][1])[-1], lng = unlist(lng[[19]][1])[-1], popup = as.character(unlist(c1[[19]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[19])%>%
      addPopups(m, lat = unlist(lat[[20]][1])[-1], lng = unlist(lng[[20]][1])[-1], popup = as.character(unlist(c1[[20]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[20])%>%
      addPopups(m, lat = unlist(lat[[21]][1])[-1], lng = unlist(lng[[21]][1])[-1], popup = as.character(unlist(c1[[21]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[21])%>%
...
m22 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[20]][1])[-1], lng = unlist(lng[[20]][1])[-1], popup = as.character(unlist(c1[[20]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[20])%>%
      addPopups(m, lat = unlist(lat[[21]][1])[-1], lng = unlist(lng[[21]][1])[-1], popup = as.character(unlist(c1[[21]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[21])%>%
      addPopups(m, lat = unlist(lat[[22]][1])[-1], lng = unlist(lng[[22]][1])[-1], popup = as.character(unlist(c1[[22]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[22])%>%
...
m23 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[21]][1])[-1], lng = unlist(lng[[21]][1])[-1], popup = as.character(unlist(c1[[21]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[21])%>%
      addPopups(m, lat = unlist(lat[[22]][1])[-1], lng = unlist(lng[[22]][1])[-1], popup = as.character(unlist(c1[[22]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[22])%>%
      addPopups(m, lat = unlist(lat[[23]][1])[-1], lng = unlist(lng[[23]][1])[-1], popup = as.character(unlist(c1[[23]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[23])%>%
...
m24 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[22]][1])[-1], lng = unlist(lng[[22]][1])[-1], popup = as.character(unlist(c1[[22]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[22])%>%
      addPopups(m, lat = unlist(lat[[23]][1])[-1], lng = unlist(lng[[23]][1])[-1], popup = as.character(unlist(c1[[23]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[23])%>%
      addPopups(m, lat = unlist(lat[[24]][1])[-1], lng = unlist(lng[[24]][1])[-1], popup = as.character(unlist(c1[[24]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[24])%>%
...
m25 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[23]][1])[-1], lng = unlist(lng[[23]][1])[-1], popup = as.character(unlist(c1[[23]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[23])%>%
      addPopups(m, lat = unlist(lat[[24]][1])[-1], lng = unlist(lng[[24]][1])[-1], popup = as.character(unlist(c1[[24]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[24])%>%
      addPopups(m, lat = unlist(lat[[25]][1])[-1], lng = unlist(lng[[25]][1])[-1], popup = as.character(unlist(c1[[25]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[25])%>%
...
m26 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[24]][1])[-1], lng = unlist(lng[[24]][1])[-1], popup = as.character(unlist(c1[[24]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[24])%>%
      addPopups(m, lat = unlist(lat[[25]][1])[-1], lng = unlist(lng[[25]][1])[-1], popup = as.character(unlist(c1[[25]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[25])%>%
      addPopups(m, lat = unlist(lat[[26]][1])[-1], lng = unlist(lng[[26]][1])[-1], popup = as.character(unlist(c1[[26]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[26])%>%
...
m27 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[25]][1])[-1], lng = unlist(lng[[25]][1])[-1], popup = as.character(unlist(c1[[25]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[25])%>%
      addPopups(m, lat = unlist(lat[[26]][1])[-1], lng = unlist(lng[[26]][1])[-1], popup = as.character(unlist(c1[[26]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[26])%>%
      addPopups(m, lat = unlist(lat[[27]][1])[-1], lng = unlist(lng[[27]][1])[-1], popup = as.character(unlist(c1[[27]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[27])%>%
...
m28 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[26]][1])[-1], lng = unlist(lng[[26]][1])[-1], popup = as.character(unlist(c1[[26]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[26])%>%
      addPopups(m, lat = unlist(lat[[27]][1])[-1], lng = unlist(lng[[27]][1])[-1], popup = as.character(unlist(c1[[27]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[27])%>%
      addPopups(m, lat = unlist(lat[[28]][1])[-1], lng = unlist(lng[[28]][1])[-1], popup = as.character(unlist(c1[[28]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[28])%>%
...
m29 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[27]][1])[-1], lng = unlist(lng[[27]][1])[-1], popup = as.character(unlist(c1[[27]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[27])%>%
      addPopups(m, lat = unlist(lat[[28]][1])[-1], lng = unlist(lng[[28]][1])[-1], popup = as.character(unlist(c1[[28]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[28])%>%
      addPopups(m, lat = unlist(lat[[29]][1])[-1], lng = unlist(lng[[29]][1])[-1], popup = as.character(unlist(c1[[29]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[29])%>%
...
m30 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[28]][1])[-1], lng = unlist(lng[[28]][1])[-1], popup = as.character(unlist(c1[[28]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[28])%>%
      addPopups(m, lat = unlist(lat[[29]][1])[-1], lng = unlist(lng[[29]][1])[-1], popup = as.character(unlist(c1[[29]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[29])%>%
      addPopups(m, lat = unlist(lat[[30]][1])[-1], lng = unlist(lng[[30]][1])[-1], popup = as.character(unlist(c1[[30]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[30])%>%
...
m31 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[29]][1])[-1], lng = unlist(lng[[29]][1])[-1], popup = as.character(unlist(c1[[29]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[29])%>%
      addPopups(m, lat = unlist(lat[[30]][1])[-1], lng = unlist(lng[[30]][1])[-1], popup = as.character(unlist(c1[[30]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[30])%>%
      addPopups(m, lat = unlist(lat[[31]][1])[-1], lng = unlist(lng[[31]][1])[-1], popup = as.character(unlist(c1[[31]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[31])%>%
...
m32 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[30]][1])[-1], lng = unlist(lng[[30]][1])[-1], popup = as.character(unlist(c1[[30]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[30])%>%
      addPopups(m, lat = unlist(lat[[31]][1])[-1], lng = unlist(lng[[31]][1])[-1], popup = as.character(unlist(c1[[31]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[31])%>%
      addPopups(m, lat = unlist(lat[[32]][1])[-1], lng = unlist(lng[[32]][1])[-1], popup = as.character(unlist(c1[[32]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[32])%>%
...
m33 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[31]][1])[-1], lng = unlist(lng[[31]][1])[-1], popup = as.character(unlist(c1[[31]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[31])%>%
      addPopups(m, lat = unlist(lat[[32]][1])[-1], lng = unlist(lng[[32]][1])[-1], popup = as.character(unlist(c1[[32]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[32])%>%
      addPopups(m, lat = unlist(lat[[33]][1])[-1], lng = unlist(lng[[33]][1])[-1], popup = as.character(unlist(c1[[33]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[33])%>%
...
m34 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[32]][1])[-1], lng = unlist(lng[[32]][1])[-1], popup = as.character(unlist(c1[[32]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[32])%>%
      addPopups(m, lat = unlist(lat[[33]][1])[-1], lng = unlist(lng[[33]][1])[-1], popup = as.character(unlist(c1[[33]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[33])%>%
      addPopups(m, lat = unlist(lat[[34]][1])[-1], lng = unlist(lng[[34]][1])[-1], popup = as.character(unlist(c1[[34]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[34])%>%
...
m35 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[33]][1])[-1], lng = unlist(lng[[33]][1])[-1], popup = as.character(unlist(c1[[33]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[33])%>%
      addPopups(m, lat = unlist(lat[[34]][1])[-1], lng = unlist(lng[[34]][1])[-1], popup = as.character(unlist(c1[[34]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[34])%>%
      addPopups(m, lat = unlist(lat[[35]][1])[-1], lng = unlist(lng[[35]][1])[-1], popup = as.character(unlist(c1[[35]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[35])%>%
...
m36 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[34]][1])[-1], lng = unlist(lng[[34]][1])[-1], popup = as.character(unlist(c1[[34]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[34])%>%
      addPopups(m, lat = unlist(lat[[35]][1])[-1], lng = unlist(lng[[35]][1])[-1], popup = as.character(unlist(c1[[35]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[35])%>%
      addPopups(m, lat = unlist(lat[[36]][1])[-1], lng = unlist(lng[[36]][1])[-1], popup = as.character(unlist(c1[[36]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[36])%>%
...
m37 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[35]][1])[-1], lng = unlist(lng[[35]][1])[-1], popup = as.character(unlist(c1[[35]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[35])%>%
      addPopups(m, lat = unlist(lat[[36]][1])[-1], lng = unlist(lng[[36]][1])[-1], popup = as.character(unlist(c1[[36]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[36])%>%
      addPopups(m, lat = unlist(lat[[37]][1])[-1], lng = unlist(lng[[37]][1])[-1], popup = as.character(unlist(c1[[37]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[37])%>%
...
m38 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[36]][1])[-1], lng = unlist(lng[[36]][1])[-1], popup = as.character(unlist(c1[[36]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[36])%>%
      addPopups(m, lat = unlist(lat[[37]][1])[-1], lng = unlist(lng[[37]][1])[-1], popup = as.character(unlist(c1[[37]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[37])%>%
      addPopups(m, lat = unlist(lat[[38]][1])[-1], lng = unlist(lng[[38]][1])[-1], popup = as.character(unlist(c1[[38]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[38])%>%
...
m39 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[37]][1])[-1], lng = unlist(lng[[37]][1])[-1], popup = as.character(unlist(c1[[37]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[37])%>%
      addPopups(m, lat = unlist(lat[[38]][1])[-1], lng = unlist(lng[[38]][1])[-1], popup = as.character(unlist(c1[[38]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[38])%>%
      addPopups(m, lat = unlist(lat[[39]][1])[-1], lng = unlist(lng[[39]][1])[-1], popup = as.character(unlist(c1[[39]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[39])%>%
...
m40 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[38]][1])[-1], lng = unlist(lng[[38]][1])[-1], popup = as.character(unlist(c1[[38]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[38])%>%
      addPopups(m, lat = unlist(lat[[39]][1])[-1], lng = unlist(lng[[39]][1])[-1], popup = as.character(unlist(c1[[39]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[39])%>%
      addPopups(m, lat = unlist(lat[[40]][1])[-1], lng = unlist(lng[[40]][1])[-1], popup = as.character(unlist(c1[[40]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[40])%>%
...
m41 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[39]][1])[-1], lng = unlist(lng[[39]][1])[-1], popup = as.character(unlist(c1[[39]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[39])%>%
      addPopups(m, lat = unlist(lat[[40]][1])[-1], lng = unlist(lng[[40]][1])[-1], popup = as.character(unlist(c1[[40]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[40])%>%
      addPopups(m, lat = unlist(lat[[41]][1])[-1], lng = unlist(lng[[41]][1])[-1], popup = as.character(unlist(c1[[41]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[41])%>%
...
m42 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[40]][1])[-1], lng = unlist(lng[[40]][1])[-1], popup = as.character(unlist(c1[[40]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[40])%>%
      addPopups(m, lat = unlist(lat[[41]][1])[-1], lng = unlist(lng[[41]][1])[-1], popup = as.character(unlist(c1[[41]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[41])%>%
      addPopups(m, lat = unlist(lat[[42]][1])[-1], lng = unlist(lng[[42]][1])[-1], popup = as.character(unlist(c1[[42]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[42])%>%
...
m43 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[41]][1])[-1], lng = unlist(lng[[41]][1])[-1], popup = as.character(unlist(c1[[41]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[41])%>%
      addPopups(m, lat = unlist(lat[[42]][1])[-1], lng = unlist(lng[[42]][1])[-1], popup = as.character(unlist(c1[[42]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[42])%>%
      addPopups(m, lat = unlist(lat[[43]][1])[-1], lng = unlist(lng[[43]][1])[-1], popup = as.character(unlist(c1[[43]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[43])%>%
...
m44 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[42]][1])[-1], lng = unlist(lng[[42]][1])[-1], popup = as.character(unlist(c1[[42]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[42])%>%
      addPopups(m, lat = unlist(lat[[43]][1])[-1], lng = unlist(lng[[43]][1])[-1], popup = as.character(unlist(c1[[43]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[43])%>%
      addPopups(m, lat = unlist(lat[[44]][1])[-1], lng = unlist(lng[[44]][1])[-1], popup = as.character(unlist(c1[[44]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[44])%>%
...
m45 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[43]][1])[-1], lng = unlist(lng[[43]][1])[-1], popup = as.character(unlist(c1[[43]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[43])%>%
      addPopups(m, lat = unlist(lat[[44]][1])[-1], lng = unlist(lng[[44]][1])[-1], popup = as.character(unlist(c1[[44]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[44])%>%
      addPopups(m, lat = unlist(lat[[45]][1])[-1], lng = unlist(lng[[45]][1])[-1], popup = as.character(unlist(c1[[45]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[45])%>%
...
m46 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[44]][1])[-1], lng = unlist(lng[[44]][1])[-1], popup = as.character(unlist(c1[[44]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[44])%>%
      addPopups(m, lat = unlist(lat[[45]][1])[-1], lng = unlist(lng[[45]][1])[-1], popup = as.character(unlist(c1[[45]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[45])%>%
      addPopups(m, lat = unlist(lat[[46]][1])[-1], lng = unlist(lng[[46]][1])[-1], popup = as.character(unlist(c1[[46]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[46])%>%
...
m47 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[45]][1])[-1], lng = unlist(lng[[45]][1])[-1], popup = as.character(unlist(c1[[45]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[45])%>%
      addPopups(m, lat = unlist(lat[[46]][1])[-1], lng = unlist(lng[[46]][1])[-1], popup = as.character(unlist(c1[[46]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[46])%>%
      addPopups(m, lat = unlist(lat[[47]][1])[-1], lng = unlist(lng[[47]][1])[-1], popup = as.character(unlist(c1[[47]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[47])%>%
...
m48 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[46]][1])[-1], lng = unlist(lng[[46]][1])[-1], popup = as.character(unlist(c1[[46]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[46])%>%
      addPopups(m, lat = unlist(lat[[47]][1])[-1], lng = unlist(lng[[47]][1])[-1], popup = as.character(unlist(c1[[47]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[47])%>%
      addPopups(m, lat = unlist(lat[[48]][1])[-1], lng = unlist(lng[[48]][1])[-1], popup = as.character(unlist(c1[[48]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[48])%>%
...
m49 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[47]][1])[-1], lng = unlist(lng[[47]][1])[-1], popup = as.character(unlist(c1[[47]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[47])%>%
      addPopups(m, lat = unlist(lat[[48]][1])[-1], lng = unlist(lng[[48]][1])[-1], popup = as.character(unlist(c1[[48]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[48])%>%
      addPopups(m, lat = unlist(lat[[49]][1])[-1], lng = unlist(lng[[49]][1])[-1], popup = as.character(unlist(c1[[49]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[49])%>%
...
m50 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[48]][1])[-1], lng = unlist(lng[[48]][1])[-1], popup = as.character(unlist(c1[[48]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[48])%>%
      addPopups(m, lat = unlist(lat[[49]][1])[-1], lng = unlist(lng[[49]][1])[-1], popup = as.character(unlist(c1[[49]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[49])%>%
      addPopups(m, lat = unlist(lat[[50]][1])[-1], lng = unlist(lng[[50]][1])[-1], popup = as.character(unlist(c1[[50]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[50])%>%
...
m51 = function(lng,lat,c1,autopav1,spalva,autolegend,autopav) {
  ...
  (z <- m %>% setView(lng = mean(unlist(lng)), lat = mean(unlist(lat)), zoom = 10) %>%
      ...
      addPopups(m, lat = unlist(lat[[49]][1])[-1], lng = unlist(lng[[49]][1])[-1], popup = as.character(unlist(c1[[49]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[49])%>%
      addPopups(m, lat = unlist(lat[[50]][1])[-1], lng = unlist(lng[[50]][1])[-1], popup = as.character(unlist(c1[[50]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[50])%>%
      addPopups(m, lat = unlist(lat[[51]][1])[-1], lng = unlist(lng[[51]][1])[-1], popup = as.character(unlist(c1[[51]])),options = popupOptions(closeOnClick = FALSE, closeButton = FALSE,maxHeight = 20), group = autopav1[51])%>%
